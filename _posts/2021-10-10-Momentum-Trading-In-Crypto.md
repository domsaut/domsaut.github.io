...
Momentum trading is a technical trading strategy in which one analyses short-term price data, buys assets that have been showing upwards-trends, and closes positions when that trend starts to lose momentum. In this strategy, the exponential moving average of price is used as a technical indicator to develop trading signals.
